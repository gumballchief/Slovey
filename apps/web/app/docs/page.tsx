    ...
    >
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <InfoCard title="2 · Run the pre-commit gate">
          Use the <code className="rounded bg-[var(--bg)] px-1 py-0.5 font-mono text-[13px]">slovey</code> CLI to run the gate locally or in CI. It checks builds, tests, architecture, and prior decisions before a change lands.
        </InfoCard>
