  ...
  return (
    ...
    >
      <div className="max-w-2xl space-y-4 text-[15px] leading-relaxed text-[color-mix(in_oklab,var(--cb-text)_88%,transparent)]">
        ...
        <p>
          Slovey captures that reasoning as a structured decision graph, tied to the pull requests and incidents that shaped it, and makes it queryable by humans and AI agents alike. The result is code written your way, reviewed against what your team already learned.
        </p>
        <p>
