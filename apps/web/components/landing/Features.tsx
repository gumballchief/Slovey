...
const FEATURES: Feat[] = [
  ...
  { title: "Continuous learning", body: "Ingests GitHub, PRs, ADRs, Slack, Notion, Jira, reviews, PagerDuty incidents, and human corrections — automatically, forever.", icon: I("M21 12a9 9 0 1 1-3-6.7|M21 4v4h-4") },
