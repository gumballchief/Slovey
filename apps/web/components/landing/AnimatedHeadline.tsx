...
// ink → accent-blue with a light band for the shimmer sweep (background-size 220%).
const GRAD = "linear-gradient(100deg,#1b1726 0%,#4f7ef7 34%,#cfd9ff 50%,#4f7ef7 66%,#1b1726 100%)";
          ...
          {word.split("").map((ch) => {
            ...
            return reduce ? (
              ...
              <motion.span
                ...
                transition={{ duration: 0.85, ease: [0.16, 1, 0.3, 1], delay: i * 0.026 }}
              >
                {inner}
              </motion.span>
            );
